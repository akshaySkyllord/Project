		...
		<form method="post">
			...
			<div class="border">
				...
				<div class="pure-form pure-form-aligned"
					...
					<header class="heading">&nbsp;&nbsp; Update Employee Details</header>
					<hr></hr>
					<fieldset>
						<div class="pure-control-group">
							<label for="name">First Name :</label> <input type="text"
								name="fname" id="fname" required="required" value="${society_list[0].fname}"
								> <span
						...
						<div class="pure-control-group">
							<label for="lname">Last Name :</label> <input type="text"
								name="lname" id="lname" required="required"value="${society_list[0].lname}"
								placeholder="Enter Last Name">
						</div>

						<div class="pure-control-group">
							<label for="email">Email Address :</label> <input type="email"
								name="email" id="email" required="required"value="${society_list[0].email}"
								placeholder="Enter Email">
						</div>

						<div class="pure-control-group">
							<label for="foo">Mobile :</label> <input type="tel" name="mobile"
								id="mobile" required="required" value="${society_list[0].mobile}"
								placeholder="Enter Mobile Number">
						</div>

						<div class="pure-control-group">
							<label for="foo">Birth Date :</label> <input type="date"
								name="bdate" id="bdate" required="required" value="${society_list[0].bdate}"
								placeholder="Enter Birth Date">
						</div>

						<div class="pure-control-group">
							<label for="foo">Company Name :</label> <input type="text"
								name="company" id="company" required="required"value="${society_list[0].company}"
						...
						<div class="pure-control-group">
							<label for="department">Department :</label> <input type="text"
								name="department" id="department" required="required"value="${society_list[0].department}"
								placeholder="Enter Department ">
						</div>

						<div class="pure-control-group">
							<label for="designation">Designation :</label> <input type="text"
								name="designation" id="designation" required="required"value="${society_list[0].designation}"
						...
						<div class="pure-control-group">
							<label for="manager">Manager :</label> <input type="text"
								name="manager" id="manager" required="required"value="${society_list[0].manager}"
						...
						<div class="pure-control-group">
							<label for="address">Address :</label> <input type="text"
								name="address" id="address" required="required"value="${society_list[0].address}"
						...
						<div class="pure-control-group">
							<label for="zip">Zip :</label> <input type="number" name="zip"
								id="zip" required="required" value="${society_list[0].zip}" placeholder="Enter ZIP ">
						</div>
